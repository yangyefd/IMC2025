...
import sys
sys.path.append('/kaggle/input/gimdkm')
...
class DKM_Matcher():
    ...
    def match(self, img_path0, img_path1):
        ...
        with torch.no_grad():
            with torch.cuda.amp.autocast():
                with warnings.catch_warnings():
                    ...
                    sparse_matches, mconf = self.model.sample(dense_matches, dense_certainty, 1024)
        ...
        m_idx = torch.cat([mask.nonzero(),mask.nonzero()],dim=1)
        return kpts0, kpts1, mconf, m_idx 